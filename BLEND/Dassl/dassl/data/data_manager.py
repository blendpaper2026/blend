...
class DataManager:
    ...
    def __init__(
        ...
        fed_train_loader_x_dict_new = defaultdict()
        if dataset.federated_train_x_new:
            for idx in range(cfg.DATASET.USERS):
                fed_train_loader_x_dict_new[idx] = build_data_loader(
                    cfg,
                    sampler_type=cfg.DATALOADER.TRAIN_X.SAMPLER,
                    data_source=dataset.federated_train_x_new[idx],
        ...
        fed_test_loader_dict_new = defaultdict()
        if dataset.federated_test_x_new:
            for idx in range(cfg.DATASET.USERS):
                # Build test_loader
                fed_test_loader_dict_new[idx] = build_data_loader(
                    cfg,
                    sampler_type=cfg.DATALOADER.TEST.SAMPLER,
                    data_source=dataset.federated_test_x_new[idx],
        ...
        self.fed_train_loader_x_dict_new = fed_train_loader_x_dict_new
        self.fed_test_loader_dict_new = fed_test_loader_dict_new
